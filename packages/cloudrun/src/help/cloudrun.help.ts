...
const helpContents = [
  ...
  },
  {
    ...
    value:
      'The artifact that is to be applied to the Cloudrun account for this stage.  The artifact should represent a valid Cloudrun manifest.',
  },
  {
  ...
  },
  {
    ...
    value: `
    <p>A Spinnaker account corresponds to a physical cloudrun cluster. If you are unsure which account to use, talk to your Spinnaker admin.</p>
    `,
  },
];
